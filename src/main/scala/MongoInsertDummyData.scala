...
object MongoInsertDummyData {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val userProfilesData = Seq(
      Document("userId" -> 1, "desiredPosition" -> "Backend Developer", "skills" -> Seq("Java", "Spring", "MySQL", "Docker")),
      Document("userId" -> 2, "desiredPosition" -> "Frontend Developer", "skills" -> Seq("JavaScript", "React", "Redux", "TypeScript")),
      Document("userId" -> 3, "desiredPosition" -> "Data Scientist", "skills" -> Seq("Python", "Machine Learning", "SQL")),
      Document("userId" -> 4, "desiredPosition" -> "DevOps Engineer", "skills" -> Seq("AWS", "Docker", "Kubernetes", "Terraform")),
      Document("userId" -> 5, "desiredPosition" -> "Project Manager", "skills" -> Seq("Agile", "Scrum", "Communication")),
      Document("userId" -> 6, "desiredPosition" -> "UX/UI Designer", "skills" -> Seq("Figma", "Sketch", "User Research")),
      Document("userId" -> 7, "desiredPosition" -> "Mobile Developer", "skills" -> Seq("Swift", "Firebase", "React Native")),
      Document("userId" -> 8, "desiredPosition" -> "System Administrator", "skills" -> Seq("Linux", "Networking", "AWS")),
      Document("userId" -> 9, "desiredPosition" -> "Blockchain Developer", "skills" -> Seq("Solidity", "Ethereum", "Smart Contracts")),
      Document("userId" -> 10, "desiredPosition" -> "Quality Assurance Engineer", "skills" -> Seq("Testing", "Automation", "Selenium", "Cypress"))
    )
